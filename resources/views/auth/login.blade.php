                        ...
                        <div class="panel-body" >
                            <form id="signupform" class="form-horizontal" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="middlename" class="form-control" name="lastname" placeholder="Last Name">
                                    </div>
                                </div>
                                    
                                <div class="form-group">
                                    <label for="initials" class="col-md-3 control-label">Initials</label>
                                    <div class="col-md-9">
                                        <input type="initials" class="form-control" name="initials" placeholder="Initials">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="email" class="col-md-3 control-label">Email Adress</label>
                                    <div class="col-md-9">
