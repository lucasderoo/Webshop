  ...
  <div class="row">
    <div class="col-md-8 offset-md-2">
      ...
      <div class="row">
        <div class="card-deck">
          <div class="card">
            <img class="card-img-top rounded mx-auto d-block" src="{{asset('images/Stock_photo_Anna.jpg') }}" alt="Card image cap">
            <div class="card-body">
          ...
          <div class="card">
            <img class="card-img-top rounded mx-auto d-block" src="{{asset('images/stock_photo_Jantje.jpeg') }}" alt="Card image cap">
            <div class="card-body">
          ...
          <div class="card">
            <img class="card-img-top rounded mx-auto d-block" src="{{asset('images/Stock_photo_Kim_Yiu.jpg') }}" alt="Card image cap">
            <div class="card-body">
